//Código para separar accionar o botão pelo js. Uma prática para separar o html d js.
document.querySelector('button.contar').addEventListener('click', superContador)
 // Eh, se matei bué para uma cena bem de leve só. Nadãm, yha.
